        ...
        <tbody class="m-datatable__body" style="">
            ...
            <tr data-row="0" class="m-datatable__row" style="height: 64px;" id="{{$order->id}}">
                ...
                <td data-field="ShipAddress" class="m-datatable__cell"><span style="width: 110px;">@switch($order->blood_type)
                    ...
                    @case(8) {{"AB-"}} @break
                    @endswitch</span></td>
                <td data-field="Amount" class="m-datatable__cell"><span style="width: 100px;">@foreach($hospitals as $hospital) @if($hospital->id == $order->to_id){{$hospital->name}}@endif @endforeach</span></td>
