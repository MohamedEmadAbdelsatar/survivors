...
<div class="m-portlet m-portlet--tab">
    ...
    <form class="m-form m-form--fit m-form--label-align-right" role="form" action="{{route('hospital.update',$hospital->id)}}" method="POST" >
            ...
            <div class="row">
                ...
                <input type="text" class="form-control m-input" id="name" placeholder="Enter Name" name="name" value="{{$hospital->name}}">
                </div>
                <div class="form-group m-form__group col-md-6" style="padding-top:0px;">
                    <label>
                        Address
                    </label>
                <input type="text" class="form-control m-input" id="address" placeholder="Enter Address" name="address" value="{{$hospital->address}}">
                </div>
            </div>
            <div class="row">
                <div class="form-group m-form__group col-md-6">
