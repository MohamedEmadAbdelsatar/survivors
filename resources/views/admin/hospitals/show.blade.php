...
<div class="m-portlet m-portlet--tab">
    ...
    <input type="hidden" id="lng" value="{{$hospital->lng}}">
            ...
            <div class="m-portlet__body col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">Hospital Name: {{$hospital->name}}</div>
                        <div class="col-md-6">Hospital Address: {{$hospital->address}}</div>
                    </div>
                    <div class="row">
                            <div class="col-md-6">Hospital Phone: {{$hospital->phone}}</div>
                            <div class="col-md-6">Hospital Mail: {{$hospital->mail}}</div>
                    </div>
                    <hr>
